...
void graph::prims()
{
    int parent[8]; //On stocke les sommet qui constitue l'Arbre minimal de recouvrement
    int distance[8]; //distance nous aide a choisir ce qui ont le cout le plus minimum
    bool vu[8]; // pour observer si un sommet n'est pas encore inclue dans l'arbre de recouvrement minimum
